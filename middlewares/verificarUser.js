...
module.exports = (req, res, next) => {
    ...
    //como el req contiene ya las configuraciones de passport vamos a preguntar si en la configuracion req.isAuthenticated que va a verificar el el usuario tenga una session activa. 
